...
- What resources have resource policies that allow untrusted service access?

This benchmark defines shared as a policy having at least one `Allow` statement that grants one or more permissions to trusted services, e.g.,
